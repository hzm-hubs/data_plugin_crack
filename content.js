...
async function extractData(pageType) {
    let fetchedData = [];
    pageType = "search";
    const currentDomain = typeof domainHelper !== "undefined" ? domainHelper.getDomain() : "other";
    const currentUrl = window.location.href;
    console.log("当前域名:", currentDomain);
    ...
    if (currentDomain === "taobao" || currentDomain === "tmall") {
        if (currentUrl.includes("/search")) {
            ...
            if (currentUrl.includes("item.taobao.com") || currentUrl.includes("detail.tmall.com")) {
        ...
        if (currentDomain === "douyin") {
            ...
            if (currentDomain === "xiaohongshu") {
                if (currentUrl.includes("/search_result") || currentUrl.includes("/explore?") || currentUrl === "https://www.xiaohongshu.com/explore") {
